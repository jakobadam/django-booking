# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-03 10:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street', models.CharField(blank=True, max_length=256, verbose_name='Street 1')),
                ...
                ('booking_status', models.CharField(blank=True, choices=[(b'status-new', b'new'), (b'status-confirmed', b'confirmed'), (b'status-paid', b'paid')], default=b'status-new', max_length=20, null=True, verbose_name=b'Booking status')),
